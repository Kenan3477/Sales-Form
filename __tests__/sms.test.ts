...
describe('SMS Utilities', () => {
  ...
  describe('buildSmsMessage', () => {
    it('should return the exact required message', () => {
      const expected = "Thank you for choosing Flash, If you have any questions, Querys or need to make a Repair. Please call us on 03308227695 and well be with you in a Flash."
