// Direct template test without imports
const fs = require('fs');

// Mock the template content directly
...
// Simulate the variable replacement like the enhanced template service does
...
const result = replaceVariables(templateContent, testData);

// Save to file
fs.writeFileSync('template-test-output.html', result);
console.log('✅ Template test saved to template-test-output.html');
console.log('📄 File length:', result.length);
console.log('✅ Contains Flash Team:', result.includes('Flash Team'));
console.log('✅ Contains CSS:', result.includes('linear-gradient'));
console.log('✅ Contains customer name:', result.includes('Giuseppe Raccio'));
console.log('✅ Contains monthly cost:', result.includes('55.98'));

console.log('\n📄 You can now open template-test-output.html in your browser to see how it should look!');